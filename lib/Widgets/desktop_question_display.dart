...
class DesktopQuestionDisplay extends StatelessWidget {
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return SizedBox(
                  height: AppSizes.height(context) * 0.12,
                  child: Padding(
          ...
          Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                minimumSize: Size.fromHeight(AppSizes.height(context) * 0.1),
              ...
              child: isLoading
                  ...
                  : Text(
                      'Submit Answer',
                      style: TextStyle(
                        fontSize: AppSizes.header(context),
                        fontWeight: FontWeight.w600,
                        color: Colors.white,
                      ),
                    ),
